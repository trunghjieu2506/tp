...
public class SavingModuleTest {
    ...
    public void testSetNewSaving() {
        ...
        String listResponse = savingList.listGoals();
    ...
    public void testListGoalsEmpty() {
        SavingList savingList = new SavingList("USD");
        String response = savingList.listGoals();
    ...
    @Test
    public void testSavingAttributesValidInput() {
    ...
    public void testParseSetGoalCommand() {
        ...
        assertTrue(command instanceof SetGoalCommand);
    }
    ...
    public void testParseCheckGoalCommand() {
        ...
        assertTrue(command instanceof ListGoalCommand);
    }
    ...
    public void testListGoalCommandExecute() {
        ...
        ListGoalCommand command = new ListGoalCommand(savingList);
        command.execute();
        String outStr = outContent.toString();
    ...
    public void testSetGoalCommandExecute() {
        SavingList savingList = new SavingList("USD");
        SetGoalCommand command = new SetGoalCommand(savingList, "Goal1",
    ...
    public void testSavingGeneralCommandPrompt() {
        ...
        String list = savingList.listGoals();
